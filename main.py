...
def scrape_book_links():
    ...
    for book_url in book_url_list:
        if book_url_list.index(book_url) > url_limit:
            ...
            time.sleep(5)
            try:
                genre_more_btn = driver.find_element(
                    By.CSS_SELECTOR, value=".BookPageMetadataSection__genres > ul:nth-child(1) > div:nth-child(3)").click()
            except NoSuchElementException:
                pass
            ...
            if genre in genre_list:
                ...
                language = None
                try:
                    # if a book doesn't have an isbn it will give language as output
                    isbn = driver.find_element(
                        By.XPATH, "/html/body/div[1]/div/main/div[1]/div[2]/div[1]/div[2]/div[6]/div/span[2]/div[1]/span/div/dl/div[3]/dd/div/div[1]").text
                except NoSuchElementException:
                    isbn = None
                else:
                    try:
                        language = driver.find_element(
                            By.CSS_SELECTOR, "div.DescListItem:nth-child(4) > dd:nth-child(2) > div:nth-child(1) > div:nth-child(1)").text
                    except NoSuchElementException:
                        if "isbn" not in isbn:
                            language = isbn
                            isbn = None
                ...
                if desired_language == language:
                    ...
                    recommended_book_section = driver.find_element(
